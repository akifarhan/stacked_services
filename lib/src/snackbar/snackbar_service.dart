...
class SnackbarService {
  ...
  Map<dynamic, SnackbarConfig?> _customSnackbarConfigs = Map<dynamic, SnackbarConfig?>();

  Map<dynamic, SnackbarConfig Function()?> _customSnackbarConfigBuilders = Map<dynamic, SnackbarConfig Function()?>();

  Map<dynamic, Widget Function(String?, Function?)?> _mainButtonBuilder = Map<dynamic, Widget Function(String?, Function?)?>();
  ...
  void registerSnackbarConfig(SnackbarConfig config) => _snackbarConfig = config;

  /// Saves the [config] against the value of [customData]
  @Deprecated('Prefer to use the registerCustomSnackbarConfig() method. Will be removed in future release')
  ...
  void showSnackbar({
    ...
    Get.snackbar(
      ...
      margin: _snackbarConfig?.margin ?? const EdgeInsets.symmetric(horizontal: 10, vertical: 25),
  ...
  Future? showCustomSnackBar({
    ...
    final snackbarConfigBuilder = _customSnackbarConfigBuilders[snackbarVariant];

    final snackbarConfig = snackbarConfigBuilder != null ? snackbarConfigBuilder() : snackbarConfigSupplied;
    ...
    final getBar = GetSnackBar(
      ...
      progressIndicatorBackgroundColor: snackbarConfig.progressIndicatorBackgroundColor,
  ...
  TextButton? _getMainButtonWidget({
    ...
    return TextButton(
      ...
      child: Text(
        ...
        style: TextStyle(
          color: config?.mainButtonTextColor ?? config?.textColor ?? Colors.white,
        ),
      ),
